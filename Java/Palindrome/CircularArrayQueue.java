...
public class CircularArrayQueue<T> implements QueueADT<T>
{
    ...
    public boolean isEmpty()
    {
        ...
        return empty;// To be completed as a Programming Project
    }
    ...
    {
       return ("There are currently " + count + " elements in the queue.\n" + "The element at the front is " + queue[front] +
       " and the element at the rear is " + queue[rear]); // To be completed as a Programming Project
    }
}
